...
class MainApp {
	...
	#userBuildUI() {
		...
		// freegroup start text size slider combo
		{
			...
			const step = .01;
			const precision = 2;
			new makeEleSliderCombo(this.vp, label, min, max, start, step, precision,  (v) => {this.textSize = v; this.dirty = true});
			// end lineStep UI
		}
		...
		// freegroup text ratio slider combo
		{
			...
			const step = .01;
			const precision = 2;
			new makeEleSliderCombo(this.vp, label, min, max, start, step, precision,  (v) => {this.textRatio = v; this.dirty = true});
			// end lineStep UI
		}
		...
		// freegroup start line size slider combo
		{
			...
			const step = .01;
			const precision = 2;
			new makeEleSliderCombo(this.vp, label, min, max, start, step, precision,  (v) => {this.lineSize = v; this.dirty = true});
			// end lineStep UI
		}
		// freegroup line ratio slider combo
		{
			...
			const step = .01;
			const precision = 2;
			new makeEleSliderCombo(this.vp, label, min, max, start, step, precision,  (v) => {this.lineRatio = v; this.dirty = true});
			// end lineStep UI
		}
		makeEle(this.vp, "hr");
	}
